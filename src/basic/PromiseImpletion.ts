...
type OnFulfilled = (value: unknown) => any
type OnRejected = (reason: unknown) => any
...
class MyPromise {
  ...
  value: unknown
  reason: unknown
  onFulfilledCallbacks: Array<OnFulfilled>
  onRejectedCallbacks: Array<OnRejected>
  ...
  static race(promiseArr: unknown[]) {
    return new Promise((resolve, reject) => {
